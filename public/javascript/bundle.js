...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(AuthorName, Email, PhoneNumber, Password) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"book.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBook = exports.deleteBook = exports.addBook = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var addBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(Title, DatePublished, Description, PageCount, Genre, BookImage, BookLandscapeImages, Summary, Publisher) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              ...
              Genre: Genre,
              BookImage: BookImage,
              BookLandscapeImages: BookLandscapeImages,
              Summary: Summary,
              Publisher: Publisher
            }
          });
  ...
  return function addBook(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteBook = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/books/delete/".concat(BookID)
          });
        case 3:
          res = _context2.sent;
          if (res.statusText === 'OK') {
            (0, _alerts.showAlert)('success', 'Book deleted successfully');
            window.setTimeout(function () {
              location.assign('/api/my-books');
            }, 1500);
          }
        ...
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('error', _context2.t0.response.data.error);
        case 10:
        case "end":
          return _context2.stop();
      }
  ...
  return function deleteBook(_x10) {
    return _ref2.apply(this, arguments);
  };
}();
exports.deleteBook = deleteBook;
var updateBook = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(BookID, Title, DatePublished, Description, PageCount, Genre, BookImage, BookLandscapeImages, Summary, Publisher) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PUT',
            url: "http://127.0.0.1:3000/books/update/".concat(BookID),
            data: {
              Title: Title,
              DatePublished: DatePublished,
              Description: Description,
        ...
        case 3:
          res = _context3.sent;
          if (res.statusText === 'OK') {
            (0, _alerts.showAlert)('success', 'Book updated successfully');
            window.setTimeout(function () {
              location.assign("/api/book/".concat(BookID));
            }, 1500);
          }
          _context3.next = 10;
          break;
        case 7:
          _context3.prev = 7;
          _context3.t0 = _context3["catch"](0);
          (0, _alerts.showAlert)('error', _context3.t0.response.data.error);
        case 10:
        case "end":
          return _context3.stop();
      }
  ...
  return function updateBook(_x11, _x12, _x13, _x14, _x15, _x16, _x17, _x18, _x19, _x20) {
    return _ref3.apply(this, arguments);
  };
}();
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(AuthorName, Email, PhoneNumber) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var updateBookForm = document.querySelector('.form--updatebook');
...
if (updateBookForm) updateBookForm.addEventListener('submit', function (event) {
  ...
  var BookLandscapeImages = BookLandscapeImagesInput.trim() !== '' ? BookLandscapeImagesInput.split(',').map(function (url) {
    return url.trim();
  }) : document.getElementById('booklandscapeimages').value;
  ;
  var Summary = document.getElementById('summary').value;
  var Publisher = document.getElementById('author').value;
